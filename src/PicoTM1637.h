...
void TM1637_put_2_bytes(TM1637_device* device, uint startPos, uint data);
 ...
 *        be put to the left. */
void TM1637_put_4_bytes(TM1637_device* device, uint startPos, uint data);
...
void TM1637_display_left(TM1637_device* device, int number, bool leadingZeros);

/** Display a positive number on the 2 rightmost digits on the display. 
 * 
 * A colon is by default shown. To turn this off use 
 * TM1637_set_colon(bool false). */
void TM1637_display_right(TM1637_device* device, int number, bool leadingZeros);

/** Display two (2 digit positive) numbers on the display. 
 * 
 * A colon is by default shown in between. To turn this off use 
 * TM1637_set_colon(bool false). */
void TM1637_display_both(TM1637_device* device, int leftNumber, int rightNumber, bool leadingZeros);
